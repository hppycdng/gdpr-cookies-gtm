...
<div class="wrapper">
    ...
    <form method="post" action="<?php echo esc_html(admin_url('admin-post.php')); ?>">
        ...
        <div id="gdpr-cookies-gtm-settings">
            ...
            <div class="options">
                <p>
                    <label for="gdpr-cookies-gtm-is-active"><?php _e('Sollen Banner und GTM-Code ausgespielt werden?', 'gdpr-cookies-gtm') ?>
                        <br/>
                        <input
                            type="checkbox"
                            name="gdpr-cookies-gtm-is-active"
                            value="is-active"
                            <?php echo (array_key_exists('is-active', $dataFromOptionsTable) && $dataFromOptionsTable[
                              'is-active' ] === 1) ? "checked" : "" ?>
                        />
                    </label>
                </p>
                <p>
                    <label for="gdpr-cookies-gtm-container-id"><?php _e('Wie lautet die GTM Container-ID?', 'gdpr-cookies-gtm') ?>
                        <br/>
                ...
                <p>
                    <label for="gdpr-cookies-gtm-banner-headline"><?php _e('Cookie Banner Überschrift', 'gdpr-cookies-gtm') ?>
                        <br/>
                        <input
                                type="text"
                ...
                <p>
                    <label><?php _e('Cookie Banner Fließtext', 'gdpr-cookies-gtm') ?>
                        <br/>
                             <?php
                ...
                <div id="gdpr-cookies-gtm-purpose-wrapper">
                     ...
                     <?php foreach ($dataFromOptionsTable['purposes'] as $key => $value): ?>
                        <p>
                            <label for="gdpr-cookies-gtm-purposes">
                                <input
                                        type="text"
                                        name="gdpr-cookies-gtm-purposes[<?php echo $key ?>][id]"
                                        value="<?php echo ($key === 0 ) ? "technically-necessary" : $value['id'] ?>"
                                ...
                                <input
                                        type="text"
                                        name="gdpr-cookies-gtm-purposes[<?php echo $key ?>][name]"
                                        value="<?php echo $value['name'] ?>"
                                        placeholder="Sample Handle"
                                />
                            </label>
                            <?php if ($key !== 0):?>
                                <span><i class="dashicons dashicons-dismiss"></i><a href="#"
                                                                              class="gdpr-cookies-gtm-remove-purpose-js">Remove</a></span>
                            <?php endif; ?>
                    ...
                    <?php endforeach; ?>
                        ...
                        <label for="gdpr-cookies-gtm-purposes">
                            <input
                                    type="text"
                                    name="gdpr-cookies-gtm-purposes[0][id]"
                                    value="<?php echo (array_key_exists('container-id', $dataFromOptionsTable)) ? $dataFromOptionsTable[ 'container-id' ] : "" ?>"
                                    placeholder="sample-handle"
                                    disabled
                            />
                            <input
                                    type="text"
                                    name="gdpr-cookies-gtm-purposes[0][name]"
                                    value="<?php echo (array_key_exists('container-id', $dataFromOptionsTable)) ? $dataFromOptionsTable[ 'container-id' ] : "" ?>"
                                    placeholder="Sample Handle"
                            />
                        </label>
